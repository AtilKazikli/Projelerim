<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            <?php echo "<b>$item->item_name</b> kaydını düzenliyorsunuz"; ?>
        </h4>
    </div><!-- END column -->
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("menus/update/$item->id"); ?>" method="post">
                <div class="form-group">
                <label>Menü Numarası</label>
                        <input class="form-control" placeholder="Menü numarası" name="manu_id">
